...
You can connect to your workspace in various ways. Options include:
...
In addition, to facilitate your agentic developments, the [Gaia LLM API has been pre-configured](llmapi.md/llmapi.md) by setting the environment variables OPENAI_BASE_URL and OPENAI_API_KEY, as well as the provision of command *llm*. You can try using this from the command line as follows:
